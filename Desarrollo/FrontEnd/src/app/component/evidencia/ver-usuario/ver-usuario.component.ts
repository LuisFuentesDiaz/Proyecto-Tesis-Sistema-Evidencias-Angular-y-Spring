...
export class VerUsuarioComponent implements OnInit {
    ...
    async pdf() {
        ...
        pdf.header(
            pdf.add(
                await new Img(
                    'http://localhost:4200/assets/imagenes/head_1evidencia.png'
                ).build()
            )
        );
        ...
        pdf.add(
            new Columns([
                'Responsable: ',
                this.responsable.rut,
                'Email: ',
                this.responsable.nombreUsuario,
            ]).end
        );
        pdf.add(
            new Table([
        ...
        if (this.dca != null) {
            pdf.add(
                new Columns(['DCA: ', this.dca.rut, 'Email: ', this.dca.nombreUsuario])
                    .end
            );
            pdf.add(
                new Table([['Observacion DCA', this.observacionDac]]).widths(['*', '*'])
                    .end
            );
        }
